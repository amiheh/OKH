...
//                    slot[i]=timeslot[i][1];
            ...
            while(!terminate){
                ...
                sbest_penalty[iteration-1] = penalty(conflict_matrix, sbest, student.size());
    ...
    public static void export_trajectory(double[] trajectory, String filename){
        try{    
            FileWriter fw=new FileWriter("C:\\TORONTO\\"+filename+"_Tabu.txt");    
            ...
            System.out.println("File trajectory "+filename+"_Tabu.txt berhasil disimpan di C");    
    }
}